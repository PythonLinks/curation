...
from zopache.python.interfaces import IPython, ITranscrypt
...
@implementer(ITranscrypt)
class Transcrypt(Leaf,SourceBase,ObjectFile):
    def __init__(self):
        Leaf.__init__(self)
...
@name("aceedit")
@permissions('Manage')
class AceEditTranscrypt(AceEditForm):
