...
from zopache.pages.addanonymous import AddAnonymousPageByName

@view_component
@name('addMeetup')
@target(IView)
@context(IPage)
class AddMeetup(AddAnonymousPageByName):
    interface = IMeetup
...
@target(IView)
@context(IPage)
class AddOnlineEvent(AddAnonymousPageByName):
...
@target(IView)
@context(IPage)
class AddEvent(AddAnonymousPageByName):
    interface = IEvent
    factory = Event
